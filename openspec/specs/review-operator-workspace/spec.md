# review-operator-workspace Specification

## Purpose
Define the shared dashboard contract for operating the review pipeline so backlog pages, task-scoped review sections, and standalone deep-review entry points reuse one consistent set of review UI behaviors.
