# built-in-control-tools Specification

## Purpose
Define the official built-in ToolPlugin control starters that expose AgentForge-native task, review, and workflow control-plane actions through maintained MCP tool contracts.
## Requirements
