# form-intake Specification

## Purpose
Define project-level intake forms that map submitted values into tasks through public or private submission flows with abuse protection.
