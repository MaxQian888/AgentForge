# im-channel-event-routing Specification

## Purpose
Define the authoritative routing contract for channel-scoped IM events so configured channels and their event subscriptions determine broadcast IM delivery targets before any compatibility fallback is used.
## Requirements
