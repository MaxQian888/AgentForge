# plugin-registry-marketplace Specification

## Purpose
Define the remote AgentForge Plugin Registry marketplace contract for operator-facing browse, availability, metadata normalization, and explicit install flows through the Go control plane.
