...
## Purpose
Define the supported developer-facing SDKs, scaffolding flows, and verification assets required to author, validate, and maintain AgentForge plugins consistently across supported plugin types.
## Requirements
