# knowledge-asset-ingestion Specification

## Purpose
Define the upload, parse, chunk, reupload, storage-abstraction, and delete lifecycle for `kind=ingested_file` knowledge assets.
