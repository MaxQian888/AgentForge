...
## Purpose
Define the contract for extracting backlink-style entity references from documents and tasks and surfacing inbound mention relationships in task and wiki experiences.
