# budget-query-api Specification

## Purpose
Define operator-facing budget query endpoints that expose authoritative project and sprint budget consumption summaries without requiring dashboard widget configuration.
## Requirements
