...
## Purpose
Define the canonical API reference documentation contract for AgentForge so contributors and operators can understand the implemented REST surfaces, request and response shapes, auth requirements, and common error behavior without reverse-engineering handlers.
## Requirements
