# live-artifact-blocks Specification

## Purpose
Define the live-artifact custom block category for the wiki editor: how operators insert agent-run, cost-summary, review, and task-group blocks that stay tied to live project entities, how those blocks persist as references rather than snapshots, and how degraded states, "open source" navigation, freeze-as-static, and per-block RBAC behave inside the hosting asset.
