# platform-native-payloads Specification

## Purpose
Define provider-native IM payload contracts for AgentForge IM Bridge so richer platform-specific messages can be validated, transported, and downgraded consistently.
