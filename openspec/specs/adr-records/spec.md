...
## Purpose
Define the architecture decision record system for AgentForge so major technical choices are recorded with clear context, decisions, and consequences in a lightweight, repo-native format.
## Requirements
