# review-pipeline-visualization Specification

## Purpose
Visual review queue with status transitions, assignment, and bulk actions. Reviewers browse a kanban-style pipeline with risk/assignee metadata, transition reviews, filter and search, view details, bulk-assign or approve, and see pipeline-wide metrics.
