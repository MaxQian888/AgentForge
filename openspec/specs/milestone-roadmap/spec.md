# milestone-roadmap Specification

## Purpose
Define milestones as first-class planning entities and provide a roadmap view that groups sprints and tasks under milestone timelines.
