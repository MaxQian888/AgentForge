# bridge-runtime-dashboard Specification

## Purpose
Define how the frontend surfaces Bridge runtime health, runtime catalog data, single-agent spawn controls, and paused-agent recovery on the Agents experience.
## Requirements
