# skill-package-preview Specification

## Purpose
Define the structured preview contract for skill packages so both repo-owned built-in skills and standalone marketplace skill items can render truthful Markdown and YAML detail from the same package model.
