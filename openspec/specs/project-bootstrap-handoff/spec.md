# project-bootstrap-handoff Specification

## Purpose
Define the project-scoped bootstrap and cross-workspace handoff contract so AgentForge can guide newly created or partially configured projects through governance, staffing, playbooks, planning, and delivery without losing explicit project context.
