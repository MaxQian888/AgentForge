# knowledge-asset-wiki-bridge Specification

## Purpose
Define the bridge between knowledge-asset content changes and the future indexing pipeline, plus the optional "materialize ingested file into editable wiki page" workflow that keeps source and derivative assets decoupled while surfacing their linkage.
