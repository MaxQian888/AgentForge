...
## Purpose
Define the security documentation contract for AgentForge so contributors can understand the implemented auth lifecycle, Tauri capability boundaries, and repository-level secure coding expectations before expanding sensitive surfaces.
## Requirements
