# desktop-runtime-debug-cli Specification

## Purpose
Define the standalone Rust desktop debug CLI contract so AgentForge can preflight frontend and sidecar prerequisites, then launch the shared desktop runtime in a foreground debugging flow without taking ownership of frontend startup.
