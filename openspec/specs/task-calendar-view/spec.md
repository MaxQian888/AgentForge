# task-calendar-view Specification

## Purpose
Define the schedule-aware calendar view for project tasks, including month and week layouts, multi-day spans, unscheduled tasks, and drag rescheduling.
## Requirements
