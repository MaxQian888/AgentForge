# workflow-visual-builder Specification

## Purpose
Drag-and-drop workflow editor with node connections. Users compose workflows on a pan/zoom canvas with typed nodes (triggers, actions, conditions, integrations), connect ports, configure nodes, test runs with execution traces, use templates, undo/redo, and import/export definitions.
