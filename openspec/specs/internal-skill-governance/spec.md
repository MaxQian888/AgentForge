# internal-skill-governance Specification

## Purpose
Define the canonical governance model for repository-managed internal skills so runtime skills, repo-assistant skills, and workflow mirrors all have explicit ownership, provenance, verification, and synchronization rules.
## Requirements
