...
## Purpose
Define the Feishu native rich-card lifecycle so the bridge can send cards, normalize callbacks, and support delayed updates with explicit fallback behavior.
## Requirements
