# desktop-shell-actions Specification

## Purpose
Define the desktop shell action contract for AgentForge, covering main-window control, supported tray or native menu quick actions, and notification activation handoff through one normalized desktop interaction surface.
## Requirements
