# knowledge-asset-search Specification

## Purpose
Define the project-scoped unified search contract across knowledge-asset kinds, the provider-agnostic response shape, the lexical index maintenance hooks, and the provider seam that allows swapping backends without breaking the REST contract.
