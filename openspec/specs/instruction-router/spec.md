...
## Purpose
Define the in-process Go instruction router contract for registered instruction definitions, request normalization, queueing, cancellation, dependency handling, and runtime introspection.
## Requirements
