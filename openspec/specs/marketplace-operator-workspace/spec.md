# marketplace-operator-workspace Specification

## Purpose
Define the standalone marketplace operator workspace for browsing, publishing, moderating, installing, and handing off marketplace items with truthful service and consumption states.
## Requirements
