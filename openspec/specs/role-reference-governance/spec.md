# role-reference-governance Specification

## Purpose
Define the authoritative governance contract for downstream role references, delete blockers, and advisory historical role usage across AgentForge control-plane surfaces.
