...
## Purpose
Define the deployment and runtime configuration documentation for AgentForge so operators can bring up the web stack, package the desktop shell, manage environment variables, and place the API behind a secure TLS terminator using repo-truthful instructions.
## Requirements
