...
## Purpose
Define how TypeScript bridge events are transported into Go over the internal websocket and how currently supported runtime events are projected back into orchestration state.
## Requirements
