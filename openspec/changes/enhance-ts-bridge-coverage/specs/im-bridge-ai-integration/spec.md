...
## Purpose
Enable IM Bridge commands to leverage TS Bridge AI capabilities (decompose, generate, classify-intent) for enhanced task management and natural language processing directly from chat platforms.
