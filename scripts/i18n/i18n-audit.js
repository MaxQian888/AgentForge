 ...
 *
 * Usage:
 *   node scripts/i18n/i18n-audit.js              # Human-readable table + JSON
 *   node scripts/i18n/i18n-audit.js --json       # JSON-only to stdout
 *   node scripts/i18n/i18n-audit.js --dir app    # Override scan directories
 *
 * Exit codes:
 *   0 — no missing keys
