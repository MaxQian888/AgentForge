...
description: Use whenever writing, reviewing, or debugging Next.js code in an App Router project. Covers file conventions, RSC boundaries, data patterns, async APIs, metadata, error handling, route handlers, image/font optimization, bundling, and hydration issues. Make sure to apply this skill before adding routes, pages, components, API handlers, or Server Actions, even if the user only mentions a small frontend change.
