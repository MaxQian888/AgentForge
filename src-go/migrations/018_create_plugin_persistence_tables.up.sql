...
CREATE INDEX idx_plugins_lifecycle_state ON plugins(lifecycle_state);
CREATE INDEX idx_plugins_runtime_host ON plugins(runtime_host);
CREATE INDEX idx_plugin_instances_project_id ON plugin_instances(project_id);
CREATE INDEX idx_plugin_events_plugin_created_at ON plugin_events(plugin_id, created_at DESC);
