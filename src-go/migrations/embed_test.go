...
func TestEmbeddedMigrationsKeepReleasedFilenamesStable(t *testing.T) {
	expected := []string{
		"018_create_plugin_control_plane_tables.up.sql",
		"018_create_plugin_control_plane_tables.down.sql",
		"018_create_plugin_persistence_tables.up.sql",
		"018_create_plugin_persistence_tables.down.sql",
		"019_create_scheduler_control_plane_tables.up.sql",
		"019_create_scheduler_control_plane_tables.down.sql",
		"020_add_review_execution_metadata.up.sql",
		"020_add_review_execution_metadata.down.sql",
		...
		"022_create_entity_links_and_task_comments.up.sql",
		"022_create_entity_links_and_task_comments.down.sql",
		"022_create_wiki_workspace_tables.up.sql",
		"022_create_wiki_workspace_tables.down.sql",
