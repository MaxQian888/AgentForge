// Package gitea is a placeholder implementation of vcs.Provider for
// Gitea. Every method returns errors.ErrUnsupported. The stub is
// registered with the vcs.Registry so configurations referring to
// "gitea" surface a clean error rather than a nil-pointer panic.
package gitea
...
func (s *Stub) Name() string { return "gitea" }
