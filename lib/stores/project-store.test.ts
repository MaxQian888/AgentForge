            ...
            runtimes: [
              {
                ...
                launchContract: {
                  ...
                  supportedOutputModes: ["text", "json", "stream-json"],
            ...
            runtimes: [
              {
                ...
                launchContract: {
                  promptTransport: "unsupported-value",
                  outputMode: "unsupported-value",
                  supportedOutputModes: ["stream-json", 9],
                  supportedApprovalModes: ["default", 7],
                  additionalDirectories: "yes",
                  envOverrides: 1,
                },
                lifecycle: {
                  stage: "unsupported-value",
                  sunsetAt: 7,
